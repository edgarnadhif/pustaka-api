...
// Repository store CRUD methods for Books table
...
// Create creates a new data to the Books table
func (r *repository) Create(book Book) (Book, error) {
	err := r.db.Create(&book).Error
	return book, err
}

// Update changes the existing data in the Books table
func (r *repository) Update(book Book) (Book, error) {
	err := r.db.Save(&book).Error
	return book, err
}

// Delete removes data from the Books table
